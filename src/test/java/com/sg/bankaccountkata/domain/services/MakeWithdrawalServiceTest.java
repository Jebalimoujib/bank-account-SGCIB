...
class MakeWithdrawalServiceTest {
    ...
    private MakeWithdrawalService makeWithdrawalServiceUnderTest;

    @BeforeEach
    void setUp() {
        makeWithdrawalServiceUnderTest = new MakeWithdrawalService(mockGetAccountPort,
                mockSaveAccountPort);
    }
    ...
    void testMakeWithdrawal() {
        ...
        // Run the test
        makeWithdrawalServiceUnderTest.makeWithdrawal(transaction);
